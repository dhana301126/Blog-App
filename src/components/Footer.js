        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button 
                  onClick={() => handleLinkClick('React category')} 
                  className="text-gray-400 hover:text-white transition-colors duration-200"
                >
                  React
                </button>
              ...
              <li>
                <button 
                  onClick={() => handleLinkClick('JavaScript category')} 
                  className="text-gray-400 hover:text-white transition-colors duration-200"
                >
                  JavaScript
                </button>
              ...
              <li>
                <button 
                  onClick={() => handleLinkClick('CSS category')} 
                  className="text-gray-400 hover:text-white transition-colors duration-200"
                >
                  CSS
                </button>
              ...
              <li>
                <button 
                  onClick={() => handleLinkClick('Web Design category')} 
                  className="text-gray-400 hover:text-white transition-colors duration-200"
                >
                  Web Design
                </button>
